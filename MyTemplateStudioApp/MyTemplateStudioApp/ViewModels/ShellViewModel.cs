...
using MyTemplateStudioApp.Views;
...
namespace MyTemplateStudioApp.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<MyWebViewPage>("Shell_MyWebView".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<MyMediaPage>("Shell_MyMedia".GetLocalized(), Symbol.Document));
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<MyTabsPage>("Shell_MyTabs".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<MyMapPage>("Shell_MyMap".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<WebView2Page>("Shell_WebView2".GetLocalized(), Symbol.Document));
